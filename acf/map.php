...
define('M_MAIN_FIELD',          'map');   // (String)   Name of main field
define('M_DISABLE_UI',          TRUE);    // (Boolean)  Enable (false) or disable (true) all default UI
define('M_DISABLE_CLICK_ZOOM',  FALSE);   // (Boolean)  Enable (false) or disable (true) zoom and center on double click
define('M_DRAGGABLE',           TRUE);    // (Boolean)  False prevent the map from being dragged
define('M_SCROLLWHEEL',         TRUE);    // (Boolean)  False disables scrollwheel zooming on the map
